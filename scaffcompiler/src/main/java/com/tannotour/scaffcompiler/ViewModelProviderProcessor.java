...
@SupportedAnnotationTypes("com.tannotour.scaffanno.anno.ViewModelProvider")
public class ViewModelProviderProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnv) {
        // 获得被该注解声明的元素
        Set<? extends Element> elements = roundEnv.getElementsAnnotatedWith(ViewModelProvider.class);
        HashMap<String, String> pathMap = new HashMap<>();
        Element actionElement = processingEnv.getElementUtils().getTypeElement(ViewModelProvider.class.getName());
        ...
        for (Element element : elements) {
            ...
            ViewModelProvider routePath = element.getAnnotation(ViewModelProvider.class);
            String className = "";
    ...
    private void generateTable(String module, HashMap<String, String> pathTable){
        ...
        TypeSpec routeTable = TypeSpec.classBuilder("ViewModelProviderTable")
                .addModifiers(Modifier.PUBLIC, Modifier.FINAL)
                .addSuperinterface(IViewModelProviderTable.class)
                .addMethod(routes.build())
                .build();
        JavaFile javaFile = JavaFile.builder("com.tannotour.smartscaff." + module + ".viewmodel", routeTable).build();
        try{
